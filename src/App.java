...
public class App {
         ...
         while (trueOrFalse) {
            ...
            try {   
                ...
                switch (startNum) {
                    ...
                    case 4: itemUpgrade(user);
                            trueOrFalse = false;
                            break;

                    case 5: gameExitOnStart(characterYn, user);
                            trueOrFalse = false;
                            break;
     ...
     * ========================================
     */
    public static void itemUpgrade(User user) throws InterruptedException {
        ...
        if ( userMoney <= 1000 ) {
            ...
            System.out.println("");
            System.out.println("** 보유 머니가 부족하여 강화가 불가 합니다. **");
            ...
            String result = upgrade.UpgradeItem(item.getItemUpGrade());

            if ( result.equals("2")) { 

                item.setItemUpGrade(item.getItemUpGrade() + 1);
                item.setItemPower(item.getItemPower() + 100);

                System.out.println("");
                System.out.println("완성 아이템등급 : " + item.getItemUpGrade());

                System.out.println("");
                System.out.println("완성 아이템파워 : " + item.getItemPower());
            } 
            ...
            try {
                ...
                if ( attackStatus == 1 ) {
                    ...
                    if( result.equals("1")) {
                        ...
                        System.out.println("");
                        System.out.println("몬스터를 물리치니 새로운 아이템이 등장하였습니다.");

                        item.setItemName("중따리템");
                        item.setItemPower(1000);
                        item.setItemSkill("화염방사기");
                        item.setItemUpGrade(0);
